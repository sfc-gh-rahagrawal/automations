-- =============================================================================
-- Deploy: Coles Retail Semantic View
-- =============================================================================
-- This file is executed via:
--   EXECUTE IMMEDIATE FROM @AUTOMATIONS_REPO/branches/main/semantic-view/02-git-repository/deploy/deploy_semantic_view.sql
--
-- It creates or replaces the semantic view with COPY GRANTS to preserve
-- existing privilege assignments.
-- =============================================================================
